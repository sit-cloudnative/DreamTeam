...
public class HistoryController {
    ...
    @PostMapping("/history/checkpoint")
    public ResponseEntity<History> createCheckpoint(@RequestBody History history){
        return new ResponseEntity<>(historyService.create(history), HttpStatus.OK);
    }

    @PutMapping("/history/checkpoint")
    public ResponseEntity<Long> updateCheckpoint(@RequestBody History history){
